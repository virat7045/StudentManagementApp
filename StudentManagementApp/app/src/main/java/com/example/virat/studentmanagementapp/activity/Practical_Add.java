...
import static com.example.virat.studentmanagementapp.other.AppConfig.URL_PRACTICAL_ADD;

public class Practical_Add extends ActionBarActivity {
    private String _id;
    ...
    TextView _title, _practical_date, _description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practical__add);
        ...
        _practical_date = (TextView) findViewById(R.id.practical_date);
        ...
        _practical_date.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    _status = "practical_date";
                    date_picker(_status);
                }
                return false;
            }
        ...
        _upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e(TAG, _practical_date.getText().toString());
                if (!_title.getText().toString().trim().isEmpty() && !_practical_date.getText().toString().trim().isEmpty()) {
                    Practical_add(_faculty_id, _lab_id, _sem, _batch, _subject, _title.getText().toString().trim(), _practical_date.getText().toString().trim(), _description.getText().toString().trim());
                } else {
        ...
        _cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Practical_Add.this.finish();

            }
        });
    }

    private void Practical_add(final String _faculty_id, final String _lab_id, final String _sem, final String _batch, final String _subject, final String _title, final String _practical_date, final String _description) {
        String tag_req_str = "Practical_update";
        StringRequest streq = new StringRequest(Request.Method.POST, URL_PRACTICAL_ADD, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.e(TAG, "Practical Add response" + response.toString());
                try {
                    ...
                    try {
                        ...
                        Snackbar.make(getWindow().getDecorView().getRootView(), "Problem in adding Practical", Snackbar.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("_practical_name", _title);
                params.put("_practical_date", _practical_date);
    ...
    private void date_picker(final String _status) {
        ...
        DatePickerDialog datepicker = new DatePickerDialog(this, R.style.CustomDatePickerDialogTheme, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                sb.append((month + 1) + "-");
                sb.append(year);
                if (_status.equals("practical_date")) {
                    _practical_date.setText(sb.toString());
                }
            }
