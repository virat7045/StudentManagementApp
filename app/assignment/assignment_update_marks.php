...
if (isset($_POST['assignment_id']) && isset($_POST['name']) && isset($_POST['e_no']) && isset($_POST['marks'])) 
{           
          
    // mysql inserting a new row
                
    $user = $db->assignment_update_marks($_POST['assignment_id'],$_POST['name'],$_POST['e_no'],$_POST['marks']);
    if ($user) {
