...
$d = new dao();                                 
extract($_GET);
$q=$d->select("student_details_tb","student_id='$student_id'");
$data=mysqli_fetch_array($q);
 ?>
                                            <form action="student_details_controller.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >

                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Enrollment No <span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="hidden" id="required2" name="student_id" value="<?php echo $data['student_id'];?>" class="form-control" required>
                                                        <input type="number" id="first-name" name="e_no" value="<?php echo $data['e_no'];?>"  required="required" class="form-control col-md-7 col-xs-12" >
                                                    </div>
                                                </div>    
                                                      ...
                                                      <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" id="first-name" name="name" value="<?php echo $data['name'];?>"  required="required" class="form-control col-md-7 col-xs-12">
                                                        </div>
                                                     </div>
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select name="sem" required="required" class="form-control col-md-7 col-xs-12">
                                                            <option value=""></option>
                                                            ...
                                                            <!-- <input type="number" id="number" name="sem" value="<?php echo $data['sem'];?>"  required="required" class="form-control col-md-7 col-xs-12" > -->
                                                        </div>
                                                    </div>
                                                      ...
                                                      <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <option value=""></option>
                                                            <option value="A"<?php if ("A"==$data['class']){echo "selected= 'selected'";} ?>>A</option>
                                                            <option value="B"<?php if ("B"==$data['class']){echo "selected= 'selected'";} ?>>B</option>
                                                            </select>
                                                            
                                                            <!-- <input type="text" id="first-name" name="classname" value="<?php echo $data['class'];?>"  required="required" class="form-control col-md-7 col-xs-12"> -->
                                                        </div>
                                                     </div>
                                                     ...
                                                     <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select name="batch" required="required" class="form-control col-md-7 col-xs-12">
                                                            <option value=""></option>
                                                            <option value="A1"<?php if ("A1"==$data['batch']){echo "selected= 'selected'";} ?>>A1</option>
                                                            <option value="A2"<?php if ("A2"==$data['batch']){echo "selected= 'selected'";} ?>>A2</option>
                                                            <option value="B1"<?php if ("B1"==$data['batch']){echo "selected= 'selected'";} ?>>B1</option>
                                                            <option value="B2"<?php if ("B2"==$data['batch']){echo "selected= 'selected'";} ?>>B2</option>
                                                            </select>
                                                            <!-- <input type="text" id="first-name" name="batch" value="<?php echo $data['batch'];?>"  required="required" class="form-control col-md-7 col-xs-12"> -->
                                                        </div>
                                                     </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                          ...
                                                          <button type="submit" class="btn btn-success" name="update_student_details">Submit</button>
