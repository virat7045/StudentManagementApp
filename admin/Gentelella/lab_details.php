                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select name="faculty_id" required="required" class="form-control col-md-7 col-xs-12">
                                                            ...
                                                            $d = new dao();
                                                            $q=$d->select("users_tb","");
                                                            while ($datay=mysqli_fetch_array($q)) {
                                                            ?>
                                                            <option value="<?php echo($datay['faculty_id']); ?>"><?php  echo($datay['name']);echo("(");  echo($datay['faculty_id']);echo(")"); ?></option> 
                                                            <?php
                                                            }
                                                             ?>
                                                            </select>
                                                    ...
                                                    <div class="item form-group">
                                                     ...
                                                     <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" id="first-name" name="subject" required="required" class="form-control col-md-7 col-xs-12">
                                                        </div>
                                                     </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                          ...
                                                          <button type="submit" class="btn btn-success" name="lab_details">Submit</button>
