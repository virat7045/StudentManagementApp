                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        ?>
                                            <tr class="even pointer">
                                                <td class=" "><?php echo($data['admin_id']); ?></td>
                                                ...
                                                <td class=" last">
                                                <a href="edit_admin.php?admin_id=<?php echo $data['admin_id']; ?>">Edit</a> &nbsp
                                                <a href="admin_controller.php?admin_id=<?php echo $data['admin_id']; ?>">Delete</a>
                                                </td>
