...
$d = new dao();                                 
extract($_GET);
$q=$d->select("users_tb","faculty_id='$faculty_id'");
$data=mysqli_fetch_array($q);
 ?>
                                            <form action="faculty_controller.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" >
                                                     ...
                                                     <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="hidden" id="required2" name="faculty_id" value="<?php echo $data['faculty_id'];?>" class="form-control" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <input type="file" name="profile" id="profile" value="value="<?php echo $data['profile'];?>""  />
                                                    ...
                                                    <button type="submit" class="btn btn-success" name="update_faculty">Submit</button>
                                                        </div>
                                                    </div>
