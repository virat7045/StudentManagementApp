                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                   ...
                                   <div class="x_title">
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <?php 
                                        $d = new dao();
                                        $q=$d->select("lab_details_tb","");
                                          while ($data=mysqli_fetch_array($q)) {
                                        ?>
                                            <tr class="even pointer">
                                                <td class=" "><?php echo($data['lab_id']); ?></td>
                                                ...
                                                <td class=" last">
                                                <a href="edit_lab_details.php?lab_id=<?php echo $data['lab_id']; ?>">Edit</a>&nbsp
                                                <a href="lab_details_controller.php?lab_id=<?php echo $data['lab_id']; ?>">Delete</a>
                                                </td>
