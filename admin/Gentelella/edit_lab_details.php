...
$d = new dao();                                 
extract($_GET);
$q=$d->select("lab_details_tb","lab_id='$lab_id'");
$data=mysqli_fetch_array($q);
 ?>
                                            <form action="lab_details_controller.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >

                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Faculty id <span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="hidden" id="required2" name="lab_id" value="<?php echo $data['lab_id'];?>" class="form-control" required>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                          ...
                                                          <button type="submit" class="btn btn-success" name="update_lab_details">Submit</button>
