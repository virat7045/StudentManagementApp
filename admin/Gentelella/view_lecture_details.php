                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                   ...
                                   <div class="x_title">
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <?php 
                                        $d = new dao();
                                        $q=$d->select("lecture_details_tb","");
                                          while ($data=mysqli_fetch_array($q)) {
                                        ?>
                                            <tr class="even pointer">
                                                <td class=" "><?php echo($data['lacture_id']); ?></td>
                                                <td class=" "><?php echo($data['faculty_id']); ?></td>
                                                <td class=" "><?php echo($data['sem']); ?></td>
                                                <td class=" "><?php echo($data['classname']); ?></td>
                                                <td class=" "><?php echo($data['subject']); ?></td>
                                                <td class=" last">
                                                 <a href="edit_lecture_details.php?lacture_id=<?php echo $data['lacture_id']; ?>">Edit</a> &nbsp
                                                <a href="lecture_details_controller.php?lacture_id=<?php echo $data['lacture_id']; ?>">Delete</a>
                                                </td>
