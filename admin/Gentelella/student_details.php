                        ...
                        <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                   ...
                                   <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            <br />
                                            <form action="test_controller.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" >

                                                <div class="form-group">
                                                        <label class="" >CSV file Fields must be in Following Order: Enrollment No, Name, Semester, Class, Batch <span class="required">*</span>
                                                        </label>
                                                    ...
                                                    <button type="submit" class="btn btn-success" name="test_submit">Submit</button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="x_content">
                                            ...
                                            <form action="student_details_controller.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="number" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="e_no">
                                                    </div>
                                                </div>    
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <select name="sem" required="required" class="form-control col-md-7 col-xs-12">
                                                            ...
                                                            <!-- <input type="number" id="number" name="sem" required="required" class="form-control col-md-7 col-xs-12" > -->
                                                        </div>
                                                    </div>
                                                      ...
                                                      <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <!-- <input type="text" id="first-name" name="classname" required="required" class="form-control col-md-7 col-xs-12"> -->
                                                        </div>
                                                     </div>
                                                     ...
                                                     <div class="item form-group">
                                                        ...
                                                        <select name="batch" required="required" class="form-control col-md-7 col-xs-12">
                                                            ...
                                                            <!-- <input type="text" id="first-name" name="batch" required="required" class="form-control col-md-7 col-xs-12"> -->
                                                        </div>
                                                     </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                          <button type="reset" class="btn btn-primary">Cancel</button>
                                                          <button type="submit" class="btn btn-success" name="student_details">Submit</button>
