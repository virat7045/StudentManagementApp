...
$d = new dao();                                 
extract($_GET);
$q=$d->select("admin_tb","admin_id='$admin_id'");
$data=mysqli_fetch_array($q);
 ?>
                                            <form action="admin_controller.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" >
                                                      ...
                                                      <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" id="first-name" name="namee" value="<?php echo $data['name'];?>" required="required" class="form-control col-md-7 col-xs-12">
                                                        </div>
                                                     </div>
                                                     ...
                                                     <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="hidden" id="required2" name="admin_id" value="<?php echo $data['admin_id'];?>" class="form-control" required>
                                                     ...
                                                     <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="password" id="password" name="password" value="<?php echo $data['password'];?>" required="required" class="form-control col-md-7 col-xs-12">
                                                        </div>
                                                     </div>
                                                      <div class="item form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <input type="file" name="profile" id="profile" value="<?php echo $data['profile'];?>" />
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                          ...
                                                          <button type="submit" name="update_admin" class="btn btn-success">Submit</button>
