                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        ?>
                                            <tr class="even pointer">
                                                ...
                                                <td class="a-right a-right "><img height="30" width="40" src="<?php echo($z);?>"></td>
                                                <td class=" last">
                                                <a href="edit_faculty.php?faculty_id=<?php echo $data['faculty_id']; ?>">Edit</a> &nbsp
                                                <a href="faculty_controller.php?faculty_id=<?php echo $data['faculty_id']; ?>">Delete</a>
                                                </td>
